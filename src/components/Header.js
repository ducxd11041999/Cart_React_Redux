...
class Header extends Component {
  render(){
      return (
       ...
       <ul className="social">
       <li>
       <a href = "localhost:3000" className="icons-sm fb-ic">
       <i className="fa fa-facebook"> </i>
       </a>
       </li>
       <li>
       <a href = "localhost:3000" className="icons-sm pin-ic">
       <i className="fa fa-pinterest"> </i>
       </a>
       </li>
       <li>
       <a href = "localhost:3000" className="icons-sm gplus-ic">
       <i className="fa fa-google-plus"> </i>
       </a>
       </li>
       <li>
       <a  href = "localhost:3000" className="icons-sm tw-ic">
       ...
       <li>
       <a href = "localhost:3000" className="collapsible-header waves-effect arrow-r">
       ...
       <li className="active">
       <a href = "localhost:3000" className="collapsible-header waves-effect arrow-r active">
       ...
       <a href = "localhost:3000" data-activates="slide-out" className="button-collapse">
       ...
       <a href = "localhost:3000" >Trang Chủ</a>
       </li>
       </ol>
       </div>
       ...
       <a href = "localhost:3000"  className="nav-link dropdown-toggle waves-effect waves-light" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true"
       aria-expanded="false">
       <i className="fa fa-user"></i> Tài Khoản</a>
       <div className="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu1">
       <a href = "localhost:3000" className="dropdown-item waves-effect waves-light">Đăng Ký</a>
       <a href = "localhost:3000" className="dropdown-item waves-effect waves-light">Đăng Nhập</a>
       <a href = "localhost:3000" className="dropdown-item waves-effect waves-light">Đăng Xuất</a>
       </div>
       </li>
       </ul>
